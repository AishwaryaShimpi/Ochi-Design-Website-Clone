...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".1" className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-Founders-Grotesk">
      ...
      <div className="w-1/2">
      <h1 className="text-[5vw] font-bold uppercase leading-none -mb-7 ">
            Presentations
          </h1>
          ...
          <div className="dets font-NeueMontreal mt-10">
            <p>L : </p>
            <a className="block text-xl font-light" href="#">432 Sunflower Road</a>
            <a className="block text-xl font-light" href="#">Mumbai, India</a>
            <a className="block text-xl font-light" href="#">22 Lotus Street</a>
            <a className="block text-xl font-light" href="#">Chennai, India</a>
          </div>
          <div className="dets font-NeueMontreal mt-10">
            <p>E : </p>
            <a className="block text-xl font-light" href="#">hello@ochi.com</a>
